...
export default function EschoolDeals() {
  ...
  return (
    <div style={s.root}>
      ...
      <nav style={s.nav}>
        <a href="#" style={s.logo}>
          eschool<span style={s.logoAccent}>deals</span>
        </a>
        <div style={s.navRight}>
          <button style={s.navIcon} title="Search">
      ...
      <section style={s.hero}>
        ...
        <h1 style={s.h1}>
          ...
          <span style={s.h1Accent}>Nothing You Don't.</span>
        </h1>
        ...
        <div style={s.strip}>
          <div style={s.stripItem}>📦 Free shipping $35+</div>
          <div style={s.stripDot} />
          <div style={s.stripItem}>🎓 10% student discount</div>
          <div style={s.stripDot} />
          <div style={s.stripItem}>🔄 30-day returns</div>
        </div>
      </section>
        ...
        <div style={s.grid}>
          {products.map((p) => (
            <div key={p.id} style={s.card}>
              {p.badge && (
                <span style={{ ...s.badge, ...(p.badge === "new" ? s.badgeNew : s.badgePop) }}>
                  {p.badge === "new" ? "New" : "Popular"}
                </span>
              )}
              <button style={s.fav} onClick={() => toggleFav(p.id)}>
                {favs[p.id] ? "♥" : "♡"}
              </button>
              ...
              <div style={s.cardBody}>
                ...
                <div style={s.cardBottom}>
                  ...
                  <button
                    style={{ ...s.addBtn, ...(added[p.id] ? s.addBtnAdded : {}) }}
      ...
      <section style={s.newsletter}>
        <h2 style={s.nlH2}>
          Get <span style={s.logoAccent}>student deals</span> in your inbox
        </h2>
      ...
      <footer style={s.footer}>
        <div style={s.footerInner}>
          <div>
            <a href="#" style={{ ...s.logo, color: "#F8F7F4", fontSize: 18 }}>
              eschool<span style={s.logoAccent}>deals</span>
            </a>
          ...
          <div>
            ...
            <ul style={s.footerList}>
              {products.map((p) => <li key={p.id}><a href="#" style={s.footerLink}>{p.name}</a></li>)}
            </ul>
          </div>
          <div>
            <div style={s.footerColTitle}>Help</div>
            <ul style={s.footerList}>
              {["Track My Order", "Returns", "Student Discount", "Contact Us", "FAQ"].map((l) => (
...
const s = {
  ...
  card: { background: "#fff", border: `1px solid ${BORDER}`, borderRadius: 18, overflow: "hidden", cursor: "pointer", position: "relative", transition: "all 0.22s" },
  ...
  addBtn: { background: INK, color: "#fff", border: "none", width: 34, height: 34, borderRadius: 9, cursor: "pointer", fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.15s" },
