...
function wrapAffiliate(url) {
    ...
    try {
          ...
          if (!parsed.hostname.includes('woot.com')) return url
          // Already wrapped — don't double-wrap
      if (parsed.hostname.includes('anrdoezrs.net') || parsed.hostname.includes('dpbolvw.net') || parsed.hostname.includes('jdoqocy.com')) return url
...
export async function POST(req) {
    ...
    // Auto-wrap Woot URLs with CJ affiliate tracking before storing
