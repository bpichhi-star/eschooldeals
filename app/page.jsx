...
const CATEGORY_FILTERS = {
  ...
  Sports: d => {
    ...
    return /\b(dumbbell|barbell|kettlebell|weight plate|resistance band|pull.?up bar|squat rack|weight bench|treadmill|stationary bike|elliptical|rowing machine|yoga mat|foam roller|gym bag|protein powder|pre.?workout|creatine|basketball|football|soccer ball|baseball|tennis racket|golf club|hockey|boxing gloves|mma|cycling|bike|helmet|skateboard|scooter|hiking boot|camping|fishing|kayak|paddleboard|running shoe|trail shoe|climbing gear|jump rope|sports bra|compression|athletic wear|workout)\b/i.test(d.title)
  },
}
