...
export const promoDeals = [
  ...
  },
  {
    ...
    thumbBg: '#edf5ed',
    merchant: 'WOOT',
    url: 'https://electronics.woot.com/offers/new-samsung-galaxy-watch-6-bespoke-edition-44mm-smartwatch-bluetooth',
    productUrl:
      'https://electronics.woot.com/offers/new-samsung-galaxy-watch-6-bespoke-edition-44mm-smartwatch-bluetooth',
  },
  {
    id: 'p4',
...
export const deals = [
  ...
  {
    id: 6,
    title: 'Dyson V8 Origin+ Cordless Vacuum | Purple',
    merchant: 'WALMART',
    category: 'Home',
