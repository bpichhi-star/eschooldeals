...
/**
     ...
     * price/retailPrice/salePrice are AmountWithCurrency objects: { amount currency }
     */
 ...
 * price/retailPrice/salePrice come as { amount, currency } objects
 */
function normalizeProduct(p) {
      const salePrice = parseFloat(p.salePrice?.amount || p.price?.amount || '0')
      const retailPrice = parseFloat(p.retailPrice?.amount || '0')
