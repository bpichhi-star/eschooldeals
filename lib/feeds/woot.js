 ...
 *   price { amount currency }, salePrice { amount currency }, title
 * NOT valid: sku, retailPrice, manufacturerName, currency, inStock
 */
async function fetchCJProducts() {
  ...
  const variables = { partnerIds: [CJ_PUBLISHER_ID] }
