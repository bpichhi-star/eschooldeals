...
/**
             ...
             * Using only core fields confirmed in CJ Product schema
             */
async function fetchCJProducts() {
              // Minimal safe field set — avoiding fields that may not exist
  const query = `
...
function normalizeProduct(p) {
  ...
  return {
                  ...
                  currency: 'USD',
                  in_stock: true, // default to true since inStock field not in CJ schema
