 ...
 * Dedup key: (source_key, product_url)
 *
 * @param {object[]} deals
 * @param {object|string} [opts]  string = legacy runId; object = { runId, status }
 *   opts.status overrides every row ('active'|'pending') — falls back to deal.status then 'active'
 */
